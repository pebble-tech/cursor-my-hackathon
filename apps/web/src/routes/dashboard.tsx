...
function CertificateNameEditor({ currentName, onSave, isSaving, isLocked }: CertificateNameEditorProps) {
      ...
      <div className="flex w-full max-w-md flex-col gap-3">
        ...
        <div className="flex gap-2">
          <Input
            ...
            className="flex-1"
          />
          <Button type="button" onClick={handleSaveClick} disabled={isSaving || editedName.trim() === currentName}>
